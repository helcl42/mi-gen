...
const struct {
    ...
    { const_cast<char*> ("var"), kwVAR},
    { const_cast<char*> ("const"), kwCONST},
    { const_cast<char*> ("begin"), kwBEGIN},
    { const_cast<char*> ("end"), kwEND},
    { const_cast<char*> ("if"), kwIF},
    { const_cast<char*> ("then"), kwTHEN},
    { const_cast<char*> ("else"), kwELSE},
    { const_cast<char*> ("while"), kwWHILE},
    { const_cast<char*> ("do"), kwDO},
    { const_cast<char*> ("write"), kwWRITE},
    { NULL, EOI}
};
